...
import { FaArrowRight, FaMapMarkerAlt, FaSearch, FaShieldAlt } from "react-icons/fa";
...
export default function Header() {
  ...
  return (
    <header className="relative overflow-hidden bg-[#fff7f5]">
      ...
      <div className="container relative z-10 mx-auto grid min-h-[calc(100vh-80px)] grid-cols-1 items-center gap-10 px-6 py-14 lg:grid-cols-[1.02fr_0.98fr] lg:py-12">
        <div className="text-center lg:text-left">
          <div className="mx-auto mb-5 inline-flex items-center gap-2 rounded-md border border-red-200 bg-white px-4 py-2 text-sm font-semibold text-red-700 shadow-sm lg:mx-0">
            <FaShieldAlt className="text-red-600" />
            Trusted blood donation network
          </div>

          <h1 className="mx-auto max-w-3xl text-4xl font-extrabold leading-tight text-slate-950 sm:text-5xl lg:mx-0 lg:text-6xl">
          ...
          <div className="mt-10 grid grid-cols-3 gap-3 text-left">
            {[
              ...
              <div
                key={label}
                className="rounded-lg border border-red-100 bg-white/85 p-4 shadow-sm"
              >
        ...
        <div className="relative">
          <div className="overflow-hidden rounded-lg border border-white bg-white shadow-2xl shadow-red-100">
            <img
              src={header_img}
          ...
          <div className="absolute bottom-5 left-5 right-5 rounded-lg border border-white/70 bg-white/95 p-5 shadow-xl backdrop-blur">
